...
VALUES ("Every year, nearly four million cats are eaten in Asia"),
	...
	("The smallest pedigreed cat is a Singapura, which can weigh just 4 pounds"),
	...
	("The first cat show was organized in eighteen seventy-one in London"),
	...
	("The largest cat breed by mean weight is the Savannah, at 10 kilograms"),
	...
	("Sometimes called the Canadian Hairless, the Sphynx is the first cat breed that has lasted this long—the breed has been around since ninteen sixty-six"),
	...
	("Cats came to the Americas from Europe as pest controllers in the seventeen fifties"),
